...
For a selected PHP or Ruby run, load the sibling on-demand provider guide:
`../_php-semantic/GUIDE.md` or `../_ruby-semantic/GUIDE.md`. Both branches emit
review-only candidates and never establish safe deletion.
