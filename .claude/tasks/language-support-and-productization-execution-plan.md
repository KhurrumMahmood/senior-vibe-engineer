...
Status: active
Current phase: P7/F2 Cohort A, publish PHP/Ruby A4 and replay installed routers; Swift A3 needs a different semantic foundation; C#/.NET remains last
Last updated: 2026-07-23 (PHP/Ruby A4 code and root value replays accepted; shared publication awaiting committed installed replay)
...
| A4 — PHP/Ruby/Swift proposal/guard | `publication_pending_installed_replay` | `a3855b0`; PHP/Ruby branches retained; Swift deferred with ML-026 | PHP `0b38efa`; Ruby `98c80aa`; shared publication pending | PHP root `9 passed`; Ruby root `18 passed`; shared matrix/router/spine `94 passed`; conformance `6 passed`; metadata `76/76`; artifact drift passed | Commit publication, replay installed routers, then open Ruby A5; Swift opens only after a working A3 foundation |
...
|---|---|---|---|---|---|---|
| PHP expansion | `complete_pending_a4_release_replay` | PHP 8.4.2/Composer 2.4.0 proven | 22 supported, zero pending implementation | A4 capability truth generated; committed installed replay pending | Pilot plus project/lexical, syntax, Composer-semantic, and accepted-evidence proposal/guard packets | A1 `35e957b`; A2 `682a4df`; A3 `42f6236`; A4 `0b38efa` |
