...
| Rust | `value_cohorts_active` | rustc/Cargo 1.97.1 plus rust-analyzer, Clippy, and rustfmt installed through rustup | 2 supported (`find-comment-drift`, `move-path`), 20 pending implementation; none unsupported; not complete | Schema-v5 column published; mutation publication in current slice | Rust spine, lexical, and mutation learning packets | spine `f86f11c`; census `28989b5`; lexical `c3bcab2`; mutation `4149971`; base publication `8c227b2` |
