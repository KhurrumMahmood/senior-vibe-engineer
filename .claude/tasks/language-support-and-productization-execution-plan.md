...
| Rust | `spine_complete_value_cohorts_next` | rustc/Cargo 1.97.1 plus rust-analyzer, Clippy, and rustfmt installed through rustup | 22 pending-implementation jobs with frozen lexical, semantic, and mutation contracts; none unsupported; not complete | Profile/doctor/inventory integrated; language column pending first value cohort | `.claude/tasks/multilanguage-learnings/rust-spine.md`; `.claude/tasks/p7-baseline/rust-pilot-baseline.json` | spine `f86f11c` plus root census integration |
