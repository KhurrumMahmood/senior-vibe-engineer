...
| Dart | `family_expansion_active` | Dependency-free Dart SDK 3.12.2 foundation plus project/lexical, locked public-analyzer syntax, and SDK-LSP semantic providers proven; Flutter remains separate | 10 supported, 1 useful partial (`map-subsystem`), 11 pending implementation; D3 awaits one additive accepted syntax-provider contract and semantic duplication awaits call-hierarchy facts | Capability column and all three router handoffs published; six shared-helper outcomes remain external-library-only rather than advertising a broken stock install | Spine, contract map, D1/D2/D4/D5 family packets, and D3 stop packet | spine `f4a5eab`; contract `8e16c5c`/`ad6f277`; implementations `70184ee`, `8821fb4`, `f246f0b`, `eb9f7a6`; D3 stop `dcd4443`; publication current slice |
