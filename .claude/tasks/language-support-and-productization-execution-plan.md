...
| A4 — PHP/Ruby/Swift proposal/guard | `ready_php_ruby` | next base is the committed A3 closeout; two worktrees now, Swift deferred with ML-026 | — | — | PHP/Ruby consume accepted producer envelopes without rerunning detection; Swift opens only after a working A3 foundation |
