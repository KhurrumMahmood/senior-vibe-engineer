...
Status: active
Current phase: P7/F2 Cohort A, wave A3 semantic read-only in progress; C#/.NET remains last
Last updated: 2026-07-23 (A3 PHP/Ruby/Swift worktrees opened from `4e3aa41`)
...
| A3 — PHP/Ruby/Swift semantic read-only | `in_progress` | `4e3aa41`; `codex/f2-php-semantic`, `codex/f2-ruby-semantic`, `codex/f2-swift-semantic` | — | — | Project/configuration identity and explicit dynamic/unresolved boundaries; revisit Ruby map disposition here |
...
|---|---|---|---|---|---|---|
| PHP expansion | `family_expansion_active` | PHP 8.4.2/Composer 2.4.0 proven | 12 supported, 10 pending implementation; not complete under full-language criteria | A1/A2 capability truth published and installed-router tested | Pilot plus project/lexical and syntax family packets | A1 `35e957b`; A2 `682a4df`; publication `f7c9311` |
...
| Ruby | `family_expansion_active` | Homebrew Ruby 3.4.1, RubyGems 3.6.2, and Bundler 2.6.2 pass direct execution smoke | 11 supported, 11 pending implementation; not complete | A1/A2 capability truth published and installed-router tested; runtime dynamic completeness stays explicit | Spine/preflight plus map, project/lexical, and syntax family packets | A1 through `debbfb2`; A2 `c4b2036`; publication `f7c9311` |
...
| Swift | `family_expansion_active` | SwiftPM-only profile/doctor/inventory and restrictive native fixture proven; SwiftSyntax and native test modules remain unavailable under CLT-only setup | 12 supported, 10 pending implementation; not complete | A1/A2 capability truth published and installed-router tested | Pilot plus project/lexical and syntax family packets | A1 `105c7a2`; A2 `f8cc3a4`; publication `f7c9311` |
