...
Status: active
Current phase: P7/F2 Cohort A, wave A3 semantic read-only preparation; C#/.NET remains last
Last updated: 2026-07-23 (A2 closed at `f7c9311`; installed replay `58 passed`)
...
| A3 — PHP/Ruby/Swift semantic read-only | `ready_to_open` | exact closeout revision after this ledger update; three worktrees | — | — | Project/configuration identity and explicit dynamic/unresolved boundaries; revisit Ruby map disposition here |
