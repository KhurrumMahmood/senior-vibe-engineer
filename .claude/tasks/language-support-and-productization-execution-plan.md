...
| Rust | `value_cohorts_active` | rustc/Cargo 1.97.1 plus rust-analyzer, Clippy, and rustfmt installed through rustup | 22 pending-implementation jobs with frozen lexical, semantic, and mutation contracts; none unsupported; not complete | Schema-v5 Rust capability column prepared; committed installed replay required | `.claude/tasks/multilanguage-learnings/rust-spine.md`; `.claude/tasks/p7-baseline/rust-pilot-baseline.json` | spine `f86f11c`; census `28989b5` |
