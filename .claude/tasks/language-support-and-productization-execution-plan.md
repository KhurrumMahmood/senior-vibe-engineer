...
Status: active
Current phase: P7/F2 Cohort A, wave A2 publication verification; C#/.NET remains last
Last updated: 2026-07-23 (A2 language implementations integrated; committed installed replay pending)
...
| P7 | Every chosen language reaches complete, value-tested language-level support | `active_cohort_a2` | — |
...
| A2 — PHP/Ruby/Swift syntax | `verification` | `98dff01`; `codex/f2-php-syntax`, `codex/f2-ruby-syntax`, `codex/f2-swift-syntax` | PHP `682a4df`; Ruby `23cc7f2` + metrics correction `c4b2036`; Swift `f8cc3a4` | PHP `42 passed`; Ruby `19 passed`; Swift `32 passed, 1 deselected`; shared publication surface `77 passed`; committed installed replay pending | Native token/compiler facts remain syntax-scoped; no syntax-as-semantics promotion |
...
|---|---|---|---|---|---|---|
| PHP expansion | `family_expansion_active` | PHP 8.4.2/Composer 2.4.0 proven | 12 supported, 10 pending implementation; not complete under full-language criteria | A1/A2 capability truth prepared; committed installed replay pending | Pilot plus project/lexical and syntax family packets | A1 `35e957b`; A2 `682a4df`; publication pending |
...
| Ruby | `family_expansion_active` | Homebrew Ruby 3.4.1, RubyGems 3.6.2, and Bundler 2.6.2 pass direct execution smoke | 11 supported, 11 pending implementation; not complete | A1/A2 capability truth prepared; runtime dynamic completeness stays explicit | Spine/preflight plus map, project/lexical, and syntax family packets | A1 through `debbfb2`; A2 `c4b2036`; publication pending |
...
| Swift | `family_expansion_active` | SwiftPM-only profile/doctor/inventory and restrictive native fixture proven; SwiftSyntax and native test modules remain unavailable under CLT-only setup | 12 supported, 10 pending implementation; not complete | A1/A2 capability truth prepared; committed installed replay pending | Pilot plus project/lexical and syntax family packets | A1 `105c7a2`; A2 `f8cc3a4`; publication pending |
