...
| Rust | `value_cohorts_active` | rustc/Cargo 1.97.1 plus rust-analyzer, Clippy, and rustfmt installed through rustup | 1 supported (`find-comment-drift`), 21 pending implementation; none unsupported; not complete | Schema-v5 column published; lexical publication in current slice | Rust spine and lexical learning packets | spine `f86f11c`; census `28989b5`; lexical `c3bcab2`; base publication `8c227b2` |
