...
| P7 | Every chosen language reaches complete, value-tested language-level support | `active_rust_value_cohorts_then_family_expansion` | — |
...
| Rust | `value_cohorts_active` | rustc/Cargo 1.97.1 plus rust-analyzer, Clippy, and rustfmt installed through rustup | 22 pending-implementation jobs with frozen lexical, semantic, and mutation contracts; none unsupported; not complete | Schema-v5 Rust capability column published; installed/router/matrix replay `226 passed, 1 skipped` | `.claude/tasks/multilanguage-learnings/rust-spine.md`; `.claude/tasks/p7-baseline/rust-pilot-baseline.json` | spine `f86f11c`; census `28989b5`; publication `8c227b2` |
