...
| Rust | `family_batches_active` | rustc/Cargo 1.97.1 plus rust-analyzer, Clippy, and rustfmt installed through rustup | 16 supported, 1 useful partial (`map-subsystem`), 5 pending implementation; none unsupported; not complete | Schema-v5 column published; lexical, syntax, and semantic family publication in current slice | Rust pilot plus three family learning packets | pilots through `f0bba1a`; lexical `d59934c`; syntax `50e36bf`; semantic `67c1372`; base publication `8c227b2` |
