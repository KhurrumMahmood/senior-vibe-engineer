...
Status: active
Current phase: P7/F2 Cohort A, open PHP/Ruby A4 proposal/guard work; Swift A3 needs a different semantic foundation; C#/.NET remains last
Last updated: 2026-07-23 (PHP/Ruby A3 published and installed replay passed; oversized Swift candidate archived off main)
...
| A4 — PHP/Ruby/Swift proposal/guard | `in_progress_php_ruby` | `a3855b0`; `codex/f2-php-proposal-guard`, `codex/f2-ruby-proposal-guard`; Swift deferred with ML-026 | — | — | PHP/Ruby consume accepted producer envelopes without rerunning detection; Swift opens only after a working A3 foundation |
...
|---|---|---|---|---|---|---|
| PHP expansion | `family_expansion_active` | PHP 8.4.2/Composer 2.4.0 proven | 17 supported, 5 pending implementation; not complete under full-language criteria | A3 capability truth published; committed installed replay `58 passed` | Pilot plus project/lexical, syntax, and Composer-semantic family packets | A1 `35e957b`; A2 `682a4df`; A3 `42f6236`; publication `c7cee0b` |
...
| Ruby | `family_expansion_active` | Homebrew Ruby 3.4.1, RubyGems 3.6.2, and Bundler 2.6.2 pass direct execution smoke | 16 supported, 6 pending implementation; not complete | A3 capability truth published; committed installed replay `58 passed`; runtime dynamic completeness stays explicit | Spine/preflight plus map, project/lexical, syntax, and RBS-semantic family packets | A1 through `debbfb2`; A2 `c4b2036`; A3 through `10015fb`; publication `c7cee0b` |
