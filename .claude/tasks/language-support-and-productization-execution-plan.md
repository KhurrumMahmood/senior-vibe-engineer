...
| B6 — C++ semantic/proposal/mutation publication | `done` | `082f4a0`; retained implementation branches; serial publication in this unit | semantic `a8949c4`; state/guard/unification `33bd2db`; move `0022241`; structure `c7c9b55`; publication in this unit | All eight focused/preserved C++ suites pass `64`; catalog/matrix plus publication/conformance pass `74`; committed installed-router replay passes | C++ is 22/22 with exact closure modes, bounded native claims, and a formerly pending adapter route |
| B7 — Kotlin spine and lexical/syntax | `ready` | TBD; root foundation then Kotlin-local lanes | — | — | Offline project boundary and pinned syntax provider pass before semantic claims |
| B8 — Kotlin semantic/proposal/mutation publication | `pending_b7` | TBD; semantic proof first, then consumers and serial mutation | — | — | Kotlin reaches maximum honest coverage; unavailable compiler semantics stay explicit |
