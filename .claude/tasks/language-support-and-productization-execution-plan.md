...
| P7 | Every chosen language reaches complete, value-tested language-level support | `active_family_expansion_ruby_and_rust` | — |
...
| Rust | `spine_active` | rustc/Cargo 1.97.1 plus rust-analyzer, Clippy, and rustfmt installed through rustup | 22 jobs undergoing initial capability census; none may be called unsupported for missing implementation | Pending spine integration | Worker-owned spine packet in progress | — |
