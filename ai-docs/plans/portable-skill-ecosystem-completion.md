...
| WP3 Load-bearing layers, bindings, and installer | in_progress | Codex | WP1, WP2 | AC-3.1–AC-3.7 | `ai-docs/specs/portable-skill-layer-distribution.md`; `reports/portable-skill-ecosystem-completion/WP3/characterization.md`; `reports/portable-skill-ecosystem-completion/WP3/slice-1-evidence.md`; `reports/portable-skill-ecosystem-completion/WP3/slice-2-evidence.md`; `reports/portable-skill-ecosystem-completion/WP3/slice-3-evidence.md` | AR-1–AR-12 are characterized and IM-1–IM-6 are complete. The source-aware core leakage guard and exact 14-skill foundation boundary are committed at `ccc6a5d`: 8 contaminated core bodies are neutral with declared Django overlays, 6 already-clean bodies remain untouched, and 88 focused routing/boundary tests plus strict 76-skill metadata pass. Current action: per-root binding loader and `extract-enum` exemplar IM-7–IM-9; Cursor/Augment runtime discovery remains a named completion risk. |
