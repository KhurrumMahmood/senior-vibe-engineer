...
| WP3 Load-bearing layers, bindings, and installer | in_progress | Codex | WP1, WP2 | AC-3.1–AC-3.7 | `ai-docs/specs/portable-skill-layer-distribution.md`; `reports/portable-skill-ecosystem-completion/WP3/characterization.md`; `reports/portable-skill-ecosystem-completion/WP3/slice-1-evidence.md`; `reports/portable-skill-ecosystem-completion/WP3/slice-2-evidence.md` | AR-1–AR-12 are characterized and IM-1–IM-4 are complete. The blocking WP3-local pre-move gate at `a0d9fa9` derives exact Git scope, executes bounded ADR 0024 checks, inventories and pins self-anchors, validates per-batch imports/typed assets, and proves stale-prose/broken-anchor attacks fail across 21 focused tests. No production skill has moved. Current action: implement core leakage lint and exact foundation de-flavoring IM-5/IM-6; Cursor/Augment runtime discovery remains a named completion risk. |
...
| WP5 Productized batch sweep and native shims | in_progress | Codex | WP1, WP2; WP4 for parser-backed members | AC-5.1–AC-5.7 | `ai-docs/specs/portable-batch-sweep.md`; `reports/portable-skill-ecosystem-completion/WP5/characterization.md`; `reports/portable-skill-ecosystem-completion/WP5/slice-0-evidence.md`; `reports/portable-skill-ecosystem-completion/WP5/slice-1-evidence.md` | AR-1–AR-12 are characterized; IM-1–IM-4 are complete. Slice 1 adds the sole identity-v2 manifest writer, canonical schema-1 writes, strict migration/alias handling, and deterministic diff semantics at `b93c196`, with 39 focused tests and clean coverage/inventory. WP4 is now verified, so all remaining WP5 slices are dependency-ready. Current action: implement native provider execution IM-5/IM-6 in parallel with subsequent bounded slices. |
