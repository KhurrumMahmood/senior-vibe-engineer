...
Last updated: 2026-07-16 by Codex (WP3/WP5 repair verification active)
...
| WP3 Load-bearing layers, bindings, and installer | in_progress | Codex | WP1, WP2 | AC-3.1–AC-3.7 | `ai-docs/specs/portable-skill-layer-distribution.md`; `reports/portable-skill-ecosystem-completion/WP3/characterization.md`; `reports/portable-skill-ecosystem-completion/WP3/slice-1-evidence.md`; `reports/portable-skill-ecosystem-completion/WP3/slice-2-evidence.md`; `reports/portable-skill-ecosystem-completion/WP3/slice-3-evidence.md` | AR-1–AR-12 are characterized and IM-1–IM-6 are complete. Fresh release review passed IM-7–IM-9 and AC-3.3/AC-3.4 at isolated evidence commit `796ab76`; verified functional commits are integrated through `7ded981`, but main-line evidence publication exposed and is repairing one test that incorrectly required the checkout to lack `.venv`. Fresh review failed IM-10–IM-12 at `26a8752`: projection coverage worked, but catalog/contracts were unbound, duplicate rows and traversal-style aliases escaped validation, runtime evidence was not independently verifiable, and direct discovery was only 2/5. A repair is active; native non-model probes prove both full and exact router-only inventories in Claude/Codex, leaving Cursor as the honest runtime gap. ADR 0042 requires router-only default activation and bounded selected-skill delegation. Current action: publish/reverify main-line Slice 4, repair/reverify Slice 5, independently review the activation amendment, then implement portfolios and the transactional routed-activation installer. |
