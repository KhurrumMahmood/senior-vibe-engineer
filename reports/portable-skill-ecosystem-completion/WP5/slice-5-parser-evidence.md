...
- `scripts/sweep/ecosystem.py` loads the existing complexity-hotspot and
  omnibus detectors directly from their supported skill paths, never from the
  historical prototype. It emits schema-1 `provider_observation` records plus
  normalized `FindingInput` rows for the single manifest writer.
- Complexity retains the characterized six-pattern bad fixture and clean good
  fixture. It requests WP4's typed Python syntax-tree capability before using
  the documented raw-tree compatibility seam; malformed input is a
  `parse_failure`, not a skipped row.
...
| mixed | `cx/python`, `omnibus/python`, `omnibus/typescript`; native `clippy/rust`, `go-vet/go` retained | 8 parser findings |
...
The focused network-denial test replaces socket creation, DNS lookup, and
...
| Owned path | SHA-256 |
|---|---|
| `.claude/skills/find-complexity-hotspots/scripts/detect.py` | `ef29452a38771877eda858b68fe0693cef70ce0aadba081de33c357f12dc9e7a` |
| `.claude/skills/find-omnibus/scripts/detect.py` | `9b958bd4be514b69b19fbd53c7a37f7b1d85abde2639d9c8b3be0e96da6d457e` |
| `scripts/sweep/ecosystem.py` | `51af1cbda576b53afddb9e8a71cda678c49cde7a4835571499b57c9517b9958c` |
...
| `tests/test_sweep_ecosystem_members.py` | `b9ff8d607b3facf06d9c144fefb2ae47bfbdd1744c6d880ed5b470f38fdbda8e` |
